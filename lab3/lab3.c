 ...
 *		
 *		Final code will have menu and 'goodbye' print commented out
 *		and marked by 'TODO' for visibility in vim.
 */
...
int main(int argc, char *argv[])
{
    ...
    char junk[MAXLINE];
    int command_number_1;   // first number found with command
    int command_number_2;   // second number found with command
    int num_items;
